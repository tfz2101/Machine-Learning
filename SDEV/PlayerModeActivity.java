...
public class PlayerModeActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Database db = new Database(sharedPref);
            ArrayList<Tournament> tourneys= db.getTournaments();
            int index = 0;
            Tournament liveTourney; 
            while (tourneys.size() < index){
            	Tournament curTourney = tourneys.get(index);
            	if (curTourney.getStatus() == "OnGoing"){
            		liveTourney = curTourney;
            		break;
            	}
            	index++;
            }
            
            ArrayList<Match> matches = liveTourney._matches;
    ...
    public static class PlaceholderFragment2 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            while (players.size() < index){
            	...
            	double curPlayerPrize = PlaceholderFragment2.calcTotalPlayerPrize(curPlayer);
            	index++;
            }
        ...
        public static double calcTotalPlayerPrize(Player player){
